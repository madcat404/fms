...
$cards = [
    'Vietnam' => [
        ["./index.php", "fa-arrow-left", "mặt sau"],
        ["./kjwt_field_inspect/inspect_jig_v.php", "fa-cog", "JIG"],
        ["./kjwt_label_inspect/label_inspect.php", "fa-barcode", "Kiểm tra tem(라벨검사기)"]
    ]     
];
?>
<!DOCTYPE html>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <?php foreach ($cards as $global => $cardList): ?>
                        <!-- Page Heading -->
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800" style="padding-top:1em; display:inline-block; vertical-align:-4px;"><?php echo  $global ?></h1>
                        </div>
