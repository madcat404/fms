            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <h1 class="h3 mb-0 text-gray-800" style="padding-top:1em; display:inline-block; vertical-align:-4px;">ECU 출고</h1>
                    </div>               
                            ...
                            <div class="card card-primary card-tabs">
                                <div class="card-header p-0 pt-1">
                                    <ul class="nav nav-tabs" id="custom-tabs-one-tab">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link <?php echo h($tab2);?>" id="tab-two" data-toggle="pill" href="#tab2">출고</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="custom-tabs-one-2th-tab" href="ecu_inquire.php?tab=out">출고내역</a>
                                        </li>
                                        <li class="nav-item">
                                ...
                                <div class="card-body">
                                    <div class="tab-content" id="custom-tabs-one-tabContent">
                                        ...
                                        <div class="tab-pane fade" id="tab1" role="tabpanel" aria-labelledby="tab-one">
                                            ...
                                            2. 만약 ECU 박스라벨의 바코드가 없거나 개별로 나가는 경우 수기입력<BR><BR>
                                            ...
                                            - [입력] seetech으로 로그인한 경우 아이윈오토로 위치 저장<BR>
                                            - [입력] seetech으로 로그인하지 않았고 그외 컴퓨터로 입력할 경우 ETC로 위치 저장<BR>
                                            ...
                                            - [수기입력] seetech으로 로그인한 경우 아이윈오토로 위치 저장<BR>
                                            - [수기입력] seetech으로 로그인하지 않았고 그외 컴퓨터로 입력할 경우 ETC로 위치 저장<BR>
                                            - [삭제] 품번 입력칸 공백제거<BR>
                                            - [결과] 비고수정<BR>
                                            - [결과] 비고수정 독점화 (수정 중일때 다른사람이 수정불가, 수정 버튼 푸쉬 후 5분동안 저장하지 않을 시 다른사람 수정 가능)<BR>
                                            - <DEL>[입력] 입력값 첫글자가 P인 경우 파레트 테이블의 정보를 불러와 저장</DEL><BR><BR>
                                        ...
                                        <div class="tab-pane fade <?php echo h($tab2_text);?>" id="tab2" role="tabpanel" aria-labelledby="tab-two">
                                            ...
                                            <div class="col-lg-12"> 
                                                ...
                                                <div class="card shadow mb-4">
                                                    ...
                                                    <form method="POST" autocomplete="off" action="ecu_out.php"> 
                                            ...
                                            <div class="col-lg-12"> 
                                                ...
                                                <div class="card shadow mb-4">
                                                    ...
                                                    <form method="POST" autocomplete="off" name="pop_form" action="ecu_out.php"> 
                                                        <!-- Card Content - Collapse -->
                                                                    ...
                                                                    <div class="col-md-2">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group">                                                
                                                                                ...
                                                                                <input type="number" class="form-control" name="size23" value="0" min="1">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- end 로트사이즈 --> 
                                                            ...
                                                            <div class="card-body table-responsive p-2">
                                                                <div class="row">
                                                                    ...
                                                                    <?php 
                                                                        if (function_exists('BOARD')) {
                                                                            BOARD(4, "primary", "파레트수량", $Count_OutputPallet ?? 0, "fas fa-pallet");
                                                                            BOARD(4, "primary", "박스수량", $Data_OutputQuantity['BOX'] ?? 0, "fas fa-boxes");
                                                                            BOARD(4, "primary", "개별수량", $Data_OutputQuantity['PCS'] ?? 0, "fas fa-puzzle-piece");
                                                                        }
                                                                    ?>
                                                                    <!-- 보드 끝 -->
                                                                </div>
                                                                ...
                                                                <?php 
                                                                    if (function_exists('ModifyData2')) {
                                                                        ModifyData2("ecu_out.php?modi=Y", "bt22", "EcuOutput");
                                                                    }
                                                                ?>
                                                                ...
                                                                <div id="table" class="table-editable">
                                                                    <table class="table table-bordered table-striped" id="table1">
                                                                        ...
                                                                        <tbody>
                                                                            <?php 
                                                                                $i = 1;
                                                                                foreach ($OutputECU_DataArray as $Data_OutputECU)
                                                                                {		
                                                                                    $cd_item_from_db = $Data_OutputECU['CD_ITEM'];
                                                                                    $row_out3 = null;
                                                                            ...
                                                                            ?>
                                                                            <tr>
                                                                                <td><?php if($modi=='Y') { echo h($Data_OutputECU['CD_ITEM']); ?> <input name='N_CD_ITEM<?php echo $i; ?>' value='<?php echo h($Data_OutputECU['CD_ITEM']); ?>' type='hidden'> <?php } else {echo h($Data_OutputECU['CD_ITEM']);} ?></td>
                                                                                <td><?php echo h($row_out3['CD_ITEM'] ?? '-'); ?></td> 
                                                                                <td><?php echo h($row_out3['NM_ITEM'] ?? ''); ?></td>                                 
                                                                                <td><?php echo h($Data_OutputECU['BOX']); ?></td>
                                                                                <td><?php echo h($Data_OutputECU['PCS']); ?></td>
                                                                                <td><?php if($modi=='Y') { echo h($Data_OutputECU['LOCATION']); ?> <input name='LOCATION<?php echo $i; ?>' value='<?php echo h($Data_OutputECU['LOCATION']); ?>' type='hidden'> <?php } else {echo h($Data_OutputECU['LOCATION']);} ?></td>
                                                                                <td><?php if($modi=='Y') { echo h($Data_OutputECU['DIRECT_YN']); ?> <input name='DIRECT_YN<?php echo $i; ?>' value='<?php echo h($Data_OutputECU['DIRECT_YN']); ?>' type='hidden'> <?php } else {echo h($Data_OutputECU['DIRECT_YN']);} ?></td>
                                                                                <td><?php if($modi=='Y') { echo h($Data_OutputECU['PALLET_YN']); ?> <input name='PALLET_YN<?php echo $i; ?>' value='<?php echo h($Data_OutputECU['PALLET_YN']); ?>' type='hidden'> <?php } else {echo h($Data_OutputECU['PALLET_YN']);} ?></td>
                                                                                <td><?php if($modi=='Y') { ?> <input value='<?php echo h($Data_OutputECU['NOTE']); ?>' name='NOTE<?php echo $i; ?>' type='text'> <?php } else {echo h($Data_OutputECU['NOTE']);} ?></td>
                                                                            </tr> 
                                                                            <?php 
                                                                                    $i++;
                                                                                }
