<?php   
    ...
    IF($bt21=="on") {
        ...
        $chk_num_result = sqlsrv_has_rows($chk_result);
        ...
        if($chk_num_result === false) {
            ...
            $record_params = array($item1, $item2, $item3, $session_row->id, $s_date);
    ...
    $c_JigInspectNeed = sqlsrv_num_rows($r_JigInspectNeed); 
    ...
    $c_JigInspectSoon = sqlsrv_num_rows($r_JigInspectSoon); 
    //메뉴 입장 시 실행 end
?>