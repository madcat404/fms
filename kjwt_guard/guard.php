                                                            ...
                                                            <div class="card-body table-responsive p-2">
                                                                ...
                                                                <table class="table table-bordered table-striped">
                                                                    ...
                                                                    <tbody>
                                                                        <?php 
                                                                            $i = 0;
                                                                            if ($Result_GuestToday) {
                                                                                while($Data_GuestToday = sqlsrv_fetch_array($Result_GuestToday, SQLSRV_FETCH_ASSOC)) {
                                                                                    $i++;
                                                                        ?>
                                                                        <tr>
                                                    ...
                                                    <div class="collapse show" id="collapseCardExample52">
                                                        <div class="card-body table-responsive p-2">
                                                            <table class="table table-bordered table-hover text-nowrap" id="table3">
                                                                <thead><tr><th>업체명</th><th>방문목적</th><th>방문시간</th></tr></thead>
                                                                <tbody>
                                                                <?php if ($Result_GuestChk): while($Data_GuestChk = sqlsrv_fetch_array($Result_GuestChk, SQLSRV_FETCH_ASSOC)): ?>
                                                                    <tr>
