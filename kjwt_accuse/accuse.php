<?php 
    ...
    // ★ [중요 수정] 로직 처리 파일(accuse_status.php)을 먼저 불러옵니다.
    // 그래야 사용자가 입력한 답을 기존 세션값과 비교하여 검증할 수 있습니다.
    include 'accuse_status.php';   

    // 3. 캡차 문제 생성 (검증이 끝난 후, 다음 번을 위한 새로운 문제 생성)
                            ...
                            <div class="card card-primary card-tabs">
                                <div class="card-header p-0 pt-1">
                                    <ul class="nav nav-tabs" id="custom-tabs-one-tab">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link <?php echo isset($tab2) ? $tab2 : '';?>" id="tab-two" data-toggle="pill" href="#tab2">제보하기</a>
                                        </li>                                                   
                                    </ul>
                                </div>
                                <div class="card-body">
                                    <div class="tab-content" id="custom-tabs-one-tabContent">
                                        ...
                                        <div class="tab-pane fade" id="tab1" role="tabpanel" aria-labelledby="tab-one">
                                            ...
                                            <div class="col-lg-12"> 
                                                <div class="card shadow mb-4">
                                                    <a href="#collapseCardExample12" class="d-block card-header py-3" data-toggle="collapse"
                                                        role="button" aria-expanded="true" aria-controls="collapseCardExample12">
                                                        <h1 class="h6 m-0 font-weight-bold text-primary">제보절차</h6>
                                                    </a>
                                                    <div class="collapse show" id="collapseCardExample12">                       
                                                        <div class="card-body">
                                                            <div class="row">
                                            ...
                                            <div class="col-lg-12"> 
                                                <div class="card shadow mb-4">
                                                    <a href="#collapseCardExample13" class="d-block card-header py-3" data-toggle="collapse"
                                                        role="button" aria-expanded="true" aria-controls="collapseCardExample13">
                                            ...
                                            <div class="col-lg-12"> 
                                                <div class="card shadow mb-4">
                                                    <a href="#collapseCardExample14" class="d-block card-header py-3" data-toggle="collapse"
                                                        role="button" aria-expanded="true" aria-controls="collapseCardExample14">
                                                        <h1 class="h6 m-0 font-weight-bold text-primary">담당</h6>
                                                    </a>
                                                    <div class="collapse show" id="collapseCardExample14">                       
                                                        <div class="card-body">
                                                            <div class="row">  
                                                                <div class="col-12 mb-2">
                                                                    <div class="card border-shadow h-100 py-2">
                                        ...
                                        <div class="tab-pane fade <?php echo isset($tab2_text) ? $tab2_text : '';?>" id="tab2" role="tabpanel" aria-labelledby="tab-two">  
                                            ...
                                            <div class="col-lg-12"> 
                                                <div class="card shadow mb-4">
                                                    <a href="#collapseCardExample21" class="d-block card-header py-3" data-toggle="collapse"
                                                        ...
                                                        <h1 class="h6 m-0 font-weight-bold text-primary">제보 작성</h6>
                                                    </a>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label class="text-danger font-weight-bold">
                                                                                <i class="fas fa-shield-alt"></i> 자동입력 방지 (보안 문자)
                                                                            </label>
                                                                            <div class="input-group">                                                                        
                                                                                <div class="input-group-prepend">
                                                                                    <span class="input-group-text font-weight-bold" style="background-color: #f8f9fc; color: #e74a3b;">
                                                                                        <?php echo $captcha_num1; ?> + <?php echo $captcha_num2; ?> = ?
                                                                                    </span>
                                                                                </div>
                                                                                <input type="number" class="form-control" name="captcha" required placeholder="위 수식의 정답을 숫자로 입력해주세요">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
